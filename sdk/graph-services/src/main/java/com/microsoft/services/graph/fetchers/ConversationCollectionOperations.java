...
public class ConversationCollectionOperations extends EntityCollectionOperations{
     ...
     */
    public ConversationCollectionOperations(String urlComponent, OrcExecutable parent) {
     ...
     */
    public ConversationCollectionOperations addParameter(String name, Object value) {
     ...
     * @return the collection operations
     */
    public ConversationCollectionOperations addHeader(String name, String value) {

...
public class ConversationThreadFetcher extends OrcEntityFetcher<ConversationThread,ConversationThreadOperations> 
     ...
     /**
     * Instantiates a new ConversationThreadFetcher.
     *
     * @param urlComponent the url component
     * @param parent the parent
     */
     public ConversationThreadFetcher(String urlComponent, OrcExecutable parent) {
        super(urlComponent, parent, ConversationThread.class, ConversationThreadOperations.class);
    }
     ...
     * @return the fetcher
     */
    public ConversationThreadFetcher addParameter(String name, Object value) {
     ...
     * @return the fetcher
     */
    public ConversationThreadFetcher addHeader(String name, String value) {

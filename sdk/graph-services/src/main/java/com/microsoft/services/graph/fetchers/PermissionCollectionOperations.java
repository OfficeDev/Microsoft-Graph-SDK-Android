...
public class PermissionCollectionOperations extends EntityCollectionOperations{
     ...
     */
    public PermissionCollectionOperations(String urlComponent, OrcExecutable parent) {
     ...
     */
    public PermissionCollectionOperations addParameter(String name, Object value) {
     ...
     * @return the collection operations
     */
    public PermissionCollectionOperations addHeader(String name, String value) {

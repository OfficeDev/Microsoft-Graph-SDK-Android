...
public class DirectoryRoleTemplateCollectionOperations extends DirectoryObjectCollectionOperations{
     ...
     */
    public DirectoryRoleTemplateCollectionOperations(String urlComponent, OrcExecutable parent) {
     ...
     * @return the collection operations
     */
    public DirectoryRoleTemplateCollectionOperations addHeader(String name, String value) {

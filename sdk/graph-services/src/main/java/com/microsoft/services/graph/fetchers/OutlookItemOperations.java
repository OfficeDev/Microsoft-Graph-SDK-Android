...
public class OutlookItemOperations extends EntityOperations {
      ...
      */
    public OutlookItemOperations(String urlComponent, OrcExecutable parent) {
     ...
     */
    public OutlookItemOperations addParameter(String name, Object value) {
     ...
     * @return the operations
     */
    public OutlookItemOperations addHeader(String name, String value) {
